...
const { checkJWTToken , checkEmail , checkTaskLength , checkContentType } = require('../middleware/middleware')
...
router.post('/', checkJWTToken, checkEmail, checkTaskLength, checkContentType, taskController.createTask);
